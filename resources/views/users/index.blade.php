...
<!--Internal   Notify -->
<link href="{{ URL::asset('zakat/assets/plugins/notify/css/notifIt.css') }}" rel="stylesheet" />
                    ...
                    <table class="table table-hover" id="example1" data-page-length='50' style=" text-align: center;">
                        <thead>
                            <tr>
                             ...
                             <th class="wd-20p border-bottom-0">تاريخ التسجيل</th>
...
<!--Internal  Notify js -->
<script src="{{ URL::asset('zakat/assets/plugins/notify/js/notifIt.js') }}"></script>
<script src="{{ URL::asset('zakat/assets/plugins/notify/js/notifit-custom.js') }}"></script>
<!-- Internal Modal js-->
<script src="{{ URL::asset('zakat/assets/js/modal.js') }}"></script>
